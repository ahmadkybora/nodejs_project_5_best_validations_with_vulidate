    ...
    <div class="container" id="register" style="display: block;" ref="register">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="jumbotron">
                        <h3 v-if="!editMode">Register Brands</h3>
                        <h3 v-if="editMode">Update Brands</h3>

                        <form @submit.prevent="editMode ? productUpdate(employee) : createProduct()">
                            <!---------------------validation------------------->
                            ...
                            <div class="my-3" v-else>
                                ...
                                <!--//-->
                                <div v-if="$v.employeeId.$anyDirty">
                                    <div class="error alert-danger" v-if="!$v.employeeId.required">Employee is required.
                                    </div>
                                </div>
                                <!--//-->
                                <div v-if="$v.description.$anyDirty">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" v-if="editMode">
                                    <textarea v-model.trim="$v.product.description.$model"
                                              :class="{ 'form-group--error': $v.product.description.$error }"
                                              name="description"
                                              id="description"
                                              class="form-control form__input"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check" v-if="editMode">
                                            <input
                                                    ...
                                                    class="form-check-input form__input"
                                                    type="radio"
                                        ...
                                        <!--//-->
                                        <div class="form-check" v-if="editMode">
                                            <input :class="{ 'form-group--error': $v.state.$error }"
                                                   class="form-check-input form__input"
                                                   type="radio"
                                                   v-model.trim="$v.product.state.$model"
                                                   name="state"
                                        ...
                                        <!--//-->
                                        <div class="form-check" v-if="editMode">
                                            <input :class="{ 'form-group--error': $v.product.state.$error }"
